...
// The main windows of Zuppi desktop.
...
constexpr char Constants::ZuppiLocaleEncoding[];
...
constexpr char Constants::ZuppiDomain[];
...
constexpr char Constants::ZuppiBZip2_exe[];
constexpr char Constants::ZuppiBZip2_dll[];
