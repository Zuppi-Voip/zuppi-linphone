...
AbstractMainPage {
	...
	function createContact(name, address) {
		var friendGui = Qt.createQmlObject('import Zuppi
											FriendGui{
											}', mainItem)
			...
			RowLayout {
				...
				Button {
					...
					onClicked: {
						...
						UtilsCpp.createCall(verifyDevicePopup.deviceAddress, {}, ZuppiEnums.MediaEncryption.Zrtp)
						onClicked: verifyDevicePopup.close()
					}
				}
			}
	...
	Dialog {
		...
		content: RowLayout {
			...
			Avatar {
				_address: "sip:a.c@sip.zuppi.site"
		...
		ColumnLayout {
			...
			ColumnLayout {
				...
				AllContactListView{
					...
					sourceFlags: ZuppiEnums.MagicSearchSource.Friends | ZuppiEnums.MagicSearchSource.FavoriteFriends | ZuppiEnums.MagicSearchSource.LdapServers
				...
				bannerContent: [
					ColumnLayout {
						...
						Text {
							...
							Layout.fillWidth: true
							text: mode === ZuppiEnums.ConsolidatedPresence.Online
								? qsTr("En ligne")
								: mode === ZuppiEnums.ConsolidatedPresence.Busy
									? qsTr("Occupé")
									: mode === ZuppiEnums.ConsolidatedPresence.DoNotDisturb
										? qsTr("Ne pas déranger")
										: qsTr("Hors ligne")
							color: mode === ZuppiEnums.ConsolidatedPresence.Online
							...
							content:  ColumnLayout {
								...
								ListView {
									...
									delegate: RowLayout {
										...
										Item{Layout.fillWidth: true}
										Image{
											visible: listViewModelData.securityLevel === ZuppiEnums.SecurityLevel.EndToEndEncryptedAndVerified
										...
										Button {
											...
											onClicked: {
												if (SettingsCpp.getDisplayDeviceCheckConfirmation()) {
													...
													UtilsCpp.createCall(listViewModelData.address, {}, ZuppiEnums.MediaEncryption.Zrtp)
