	...
	centerContent: ColumnLayout {
		...
		RowLayout {
			...
			Image {
				...
				source: carousel.currentIndex == 0 ? AppIcons.welcomeZuppiLogo : carousel.currentIndex == 1 ? AppIcons.welcomeLock : AppIcons.welcomeOpenSource
			}
			Carousel {
				id: carousel
				...
				itemsList: Repeater {
					id: slideRepeater
					model: [
					{title: qsTr("Zuppi"), text: qsTr("Une application de communication <b>sécurisée</b>,<br> <b>open source</b> et <b>française</b>.")},
