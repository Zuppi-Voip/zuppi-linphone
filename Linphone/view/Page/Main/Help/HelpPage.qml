	...
	leftPanelContent: ColumnLayout {
		...
		ColumnLayout {
			...
			HelpIconLabelButton {
				...
				subTitle: qsTr("Comment Zuppi récolte et utilise les informations")
				onClicked: {
			...
			HelpIconLabelButton {
				...
				title: qsTr("Contribuer à la traduction de Zuppi")
				onClicked: {
					rightPanelStackView.clear()
		...
		HelpIconLabelButton {
			...
			onClicked: {
				rightPanelStackView.clear()
				rightPanelStackView.push("qrc:/qt/qml/Zuppi/view/Page/Layout/Settings/DebugSettingsLayout.qml", { titleText: troubleShooting.title, container: rightPanelStackView })
			}
		}
		Item {
			Layout.fillHeight: true
