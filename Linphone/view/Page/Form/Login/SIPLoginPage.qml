...
import ConstantsCpp
import SettingsCpp
import 'qrc:/qt/qml/Zuppi/view/Control/Tool/Helper/utils.js' as Utils
				...
				ColumnLayout {
					...
					ColumnLayout {
						...
						Text {
							...
							text: "Certaines fonctionnalités nécessitent un compte Zuppi, comme la messagerie de groupe, les vidéoconférences..."
						}
						Text {
							Layout.fillWidth: true
							Layout.preferredWidth: rootStackView.width
			...
			ColumnLayout {
				...
				FormItemLayout {
					...
					contentItem: ComboBox {
						...
						valueRole: "value"
						model: [
							{text: "TCP", value: ZuppiEnums.TransportType.Tcp},
							{text: "UDP", value: ZuppiEnums.TransportType.Udp},
							{text: "TLS", value: ZuppiEnums.TransportType.Tls},
							{text: "DTLS", value: ZuppiEnums.TransportType.Dtls}
						]
				...
				TemporaryText {
					...
					Connections {
						...
						function onRegistrationStateChanged() {
							if (LoginPageCpp.registrationState === ZuppiEnums.RegistrationState.Ok) {
				...
				Button {
					...
					contentItem: StackLayout {
						...
						Connections {
							target: LoginPageCpp
							function onRegistrationStateChanged() {
								if (LoginPageCpp.registrationState != ZuppiEnums.RegistrationState.Progress) {
