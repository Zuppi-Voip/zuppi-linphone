...
Item {
	...
	Item{
		Popup {
			...
			visible: currentCall
				&& currentCall.core.state != ZuppiEnums.CallState.Idle 
				&& currentCall.core.state != ZuppiEnums.CallState.IncomingReceived
				&& currentCall.core.state != ZuppiEnums.CallState.PushIncomingReceived
