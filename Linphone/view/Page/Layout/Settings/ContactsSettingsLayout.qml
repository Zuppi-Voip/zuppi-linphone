...
AbstractSettingsLayout {
	...
	contentModel: [
		...
		},
		{
			...
			subTitle: qsTr("Ajouter un carnet d’adresse CardDAV pour synchroniser vos contacts Zuppi avec un carnet d’adresse tiers."),
	...
	function createGuiObject(name) {
		return Qt.createQmlObject('import Zuppi; '+name+'Gui{}', mainItem)
	}
