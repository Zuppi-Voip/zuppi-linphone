...
Item{
	...
	onCallStateChanged: if (callState === ZuppiEnums.CallState.End || callState === ZuppiEnums.CallState.Released) preview.visible = false
	...
	RowLayout{
		...
		ListView{
			...
			delegate: Item{	// Spacing workaround
				visible: $modelData && mainItem.callState != ZuppiEnums.CallState.End  && mainItem.callState != ZuppiEnums.CallState.Released
