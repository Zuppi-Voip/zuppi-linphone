...
Item {
	...
	function setConferenceLayout() {
		...
		callLayout.sourceComponent = mainItem.conferenceLayout == ZuppiEnums.ConferenceLayout.ActiveSpeaker
	...
	Text {
		...
		z: 1
		visible: mainItem.callState === ZuppiEnums.CallState.End || mainItem.callState === ZuppiEnums.CallState.Error || mainItem.callState === ZuppiEnums.CallState.Released
