...
ColumnLayout {
	...
	RoundedPane {
		...
		contentItem: ColumnLayout {
			...
			ColumnLayout {
				...
				Text {
					property bool isPostQuantum: mainItem.call.core.encryption === ZuppiEnums.MediaEncryption.Zrtp && mainItem.call.core.zrtpStats.isPostQuantum
				...
				ColumnLayout {
					visible: mainItem.call && mainItem.call.core.encryption === ZuppiEnums.MediaEncryption.Zrtp
					Text {
	...
	Button {
		visible: mainItem.call && !mainItem.call.core.conference && mainItem.call.core.encryption === ZuppiEnums.MediaEncryption.Zrtp
		Layout.fillWidth: true
