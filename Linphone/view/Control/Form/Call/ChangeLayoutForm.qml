			...
			contentItem: ColumnLayout {
				...
				Repeater {
					...
					RadioButton {
						...
						checked: index == 0
									? mainItem.conferenceLayout === ZuppiEnums.ConferenceLayout.Grid
									: index == 1
										? mainItem.conferenceLayout === ZuppiEnums.ConferenceLayout.ActiveSpeaker
										: mainItem.conferenceLayout === ZuppiEnums.ConferenceLayout.AudioOnly
