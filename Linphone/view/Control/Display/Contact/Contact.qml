	...
	contentItem: RowLayout{
		...
		Control.Control {
			...
			contentItem: Text {
				...
				property int mode : !mainItem.account || mainItem.account.core.registrationState == ZuppiEnums.RegistrationState.Ok
												? 0
												: mainItem.account.core.registrationState == ZuppiEnums.RegistrationState.Cleared || mainItem.account.core.registrationState == ZuppiEnums.RegistrationState.None
													? 1
													: mainItem.account.core.registrationState == ZuppiEnums.RegistrationState.Progress || mainItem.account.core.registrationState == ZuppiEnums.RegistrationState.Refreshing
														? 2
														: 3
				// Test texts
				// Timer{
