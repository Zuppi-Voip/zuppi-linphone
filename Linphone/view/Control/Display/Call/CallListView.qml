	...
	delegate: RowLayout {
		...
		ColumnLayout {
			...
			Text {
				...
				text: modelData.core.state === ZuppiEnums.CallState.Paused
				|| modelData.core.state === ZuppiEnums.CallState.PausedByRemote
					? type + qsTr(" en pause")
					: type + qsTr(" en cours")
				font {
		...
		Button {
			...
			property bool isPaused: modelData.core.state === ZuppiEnums.CallState.Paused 
			|| modelData.core.state === ZuppiEnums.CallState.PausedByRemote
