...
ParticipantDeviceCore::ParticipantDeviceCore(const std::shared_ptr<linphone::ParticipantDevice> &device,
	...
	mState = ZuppiEnums::fromZuppi(device->getState());
...
void ParticipantDeviceCore::setSelf(QSharedPointer<ParticipantDeviceCore> me) {
	...
	mParticipantDeviceModelConnection->makeConnectToModel(
	    &ParticipantDeviceModel::stateChanged, [this](ZuppiEnums::ParticipantDeviceState state) {
...
ZuppiEnums::ParticipantDeviceState ParticipantDeviceCore::getState() const {
	return mState;
}
...
void ParticipantDeviceCore::setState(ZuppiEnums::ParticipantDeviceState state) {
	if (mState != state) {
		mState = state;
		emit stateChanged();
	}
...
void ParticipantDeviceCore::onStateChanged(ZuppiEnums::ParticipantDeviceState state) {
	switch (state) {
		case ZuppiEnums::ParticipantDeviceState::Joining:
			break;
		case ZuppiEnums::ParticipantDeviceState::Present:
			setPaused(false);
			break;
		case ZuppiEnums::ParticipantDeviceState::Leaving:
			break;
		case ZuppiEnums::ParticipantDeviceState::Left:
			break;
		case ZuppiEnums::ParticipantDeviceState::ScheduledForJoining:
			break;
		case ZuppiEnums::ParticipantDeviceState::ScheduledForLeaving:
			break;
		case ZuppiEnums::ParticipantDeviceState::OnHold:
			setPaused(true);
			break;
		case ZuppiEnums::ParticipantDeviceState::Alerting:
			break;
		case ZuppiEnums::ParticipantDeviceState::MutedByFocus:
			break;
		default: {
		}
	}
