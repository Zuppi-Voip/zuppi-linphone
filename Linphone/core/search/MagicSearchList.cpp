...
MagicSearchList::MagicSearchList(QObject *parent) : ListProxy(parent) {
	...
	mAggregationFlag = ZuppiEnums::MagicSearchAggregation::Friend;
	mSearchFilter = "*";
}
	...
	mCoreModelConnection->invokeToModel([this] {
		...
		mCoreModelConnection->invokeToCore([this, magicSearch] {
			...
			mModelConnection->makeConnectToCore(
			    ...
			    [this](QString filter, int sourceFlags, ZuppiEnums::MagicSearchAggregation aggregationFlag,
			           int maxResults) {
				    resetData();
...
ZuppiEnums::MagicSearchAggregation MagicSearchList::getAggregationFlag() const {
	return mAggregationFlag;
}

void MagicSearchList::setAggregationFlag(ZuppiEnums::MagicSearchAggregation flags) {
