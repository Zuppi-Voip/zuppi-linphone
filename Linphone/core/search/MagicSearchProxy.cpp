...
ZuppiEnums::MagicSearchAggregation MagicSearchProxy::getAggregationFlag() const {
	return mList->getAggregationFlag();
}

void MagicSearchProxy::setAggregationFlag(ZuppiEnums::MagicSearchAggregation flag) {
